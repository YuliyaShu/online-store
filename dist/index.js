...
class Search {
    static drawSearch() {
        ...
        this.searchElement = Utils_1.default.createAnyElement(this.headerSearchForm.element, {
            ...
            .element;
        const searchVal = Utils_1.default.getArrayFromStorage('searchData');
        if (searchVal.length) {
